...
const testimonials = [
  {
    ...
    name: "Ayesha Rahman",
    role: "Bride",
    content: "Sri Raj Photography captured our family moments exceptionally well. Their team was professional, friendly, and made us feel so comfortable. The photos look straight out of a fairy tale!",
    rating: 5,
