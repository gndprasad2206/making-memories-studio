      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif font-bold text-foreground leading-[1.1] mb-6">
              ...
              <span className="text-gradient">Beautiful Memories</span>
            </h1>
            <p className="text-lg md:text-xl text-foreground/80 font-light max-w-2xl mx-auto leading-relaxed">
              We capture life's most precious occasions with professional elegance. From timeless wedding stories to joyful family moments, our lenses tell your unique story.
            </p>
          </motion.div>
        ...
        >
          <div className="h-64 sm:h-80 md:h-[28rem] rounded-[2rem] bg-gray-200 overflow-hidden shadow-2xl relative md:mt-12 group">
            ...
            <img src="https://images.unsplash.com/photo-1511285560929-80b456fea0bc?q=80&w=800&auto=format&fit=crop" alt="Wedding" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
          </div>
          <div className="h-64 sm:h-80 md:h-[32rem] rounded-[2rem] bg-gray-200 overflow-hidden shadow-2xl relative z-10 group">
            <div className="absolute inset-0 bg-black/10 transition-opacity group-hover:bg-black/0 z-10" />
            <img src="https://images.unsplash.com/photo-1519741497674-611481863552?q=80&w=800&auto=format&fit=crop" alt="Couple" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
          </div>
          <div className="h-64 sm:h-80 md:h-[28rem] rounded-[2rem] bg-gray-200 overflow-hidden shadow-2xl relative md:mt-12 group">
            <div className="absolute inset-0 bg-black/10 transition-opacity group-hover:bg-black/0 z-10" />
            <img src="https://images.unsplash.com/photo-1542038784456-1ea8e935640e?q=80&w=800&auto=format&fit=crop" alt="Photography Studio" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
          </div>
        </motion.div>
      </div>
    </section>
